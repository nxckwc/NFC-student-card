...
import { PersonAccounts24Filled, PersonAccounts24Regular } from '@fluentui/react-icons';
const dashboard = () => {
  return (
      <main className={'flex min-h-screen bg-[#1a1a1a] pt-15 flex-col overflow-auto'}>
          <div>
              <div className={'flex flex-col gap-2 min-w-screen p-2'}>
                  ...
                  <div className={'overflow-auto flex flex-row gap-4 '}>
                      <div className={'min-h-50 min-w-[80%] bg-[#3C3C3C]/30 rounded-md'}></div>
                      <div className={'min-h-50 min-w-[80%] bg-[#3C3C3C] rounded-md'}></div>
                      <div className={'min-h-50 min-w-[80%] bg-[#3C3C3C]/30 rounded-md'}></div>
                  </div>
